  ...
  <div class="container">
    ...
    <nav>
      <ul>
        ...
        <li>{{ HTML::link_to_route('involved', '<p class="nav">get</p><p>involved</p>', null, array('encode' => false)) }}<div class="middle"></li>
        <li>{{ HTML::link_to_route('about', '<p class="nav">about</p><p>us</p>', null, array('encode' => false)) }}<div class="last"></div></li>
